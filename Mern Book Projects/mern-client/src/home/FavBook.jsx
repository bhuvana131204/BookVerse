  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>You can comfortably explore the blend of several books and experience the magic of reading your favourite book....</p>
            {/* stats */}
            ...
            hover:bg-black transition-all duration-300'>Explore Here</button></Link>
        </div>
